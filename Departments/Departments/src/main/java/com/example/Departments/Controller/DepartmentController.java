...
import  com.example.Departments.Service.DepartmentRepository;
import com.example.Departments.Exceptions.DepartmentNotFoundException;
   ...
   DepartmentRepository repository;
    ...
    Department replaceDepartment(@RequestBody Department newDepartment, @PathVariable Long id){
       ...
       //Map represents a mapping between a key and a value
        ...
        .orElseGet(() ->{
          newDepartment.setDepartmentId((long) id.intValue());
          return repository.save(newDepartment);
        });
