...
import com.example.Departments.Exceptions.TeachersNotFoundException;
import com.example.Departments.Model.Teachers;
import com.example.Departments.Service.TeachersRepository;
   ...
   TeachersRepository repository;
    ...
    Teachers replaceTeachers(@RequestBody Teachers newTeachers,@PathVariable Long id){
       ...
       //Map represents a mapping between a key and a value
        ...
        .orElseGet(() ->{
          newTeachers.setTeach_id((long) id.intValue());
          return repository.save(newTeachers);
        });
